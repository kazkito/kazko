 ...
 * @author hp
 */
@WebServlet(name = "inicioinvitado", urlPatterns = {"/inicioinvitado"})
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
         ...
         Object style = session.getAttribute("style");
            ...
            out.println("<title>Servlet inicioinvitado</title>");            
            out.println("</head>");
            out.println("<body  background=\"10.jpg\">");
 out.println(" <div> \n" +
"<ul id=\"menu\" >\n" +
