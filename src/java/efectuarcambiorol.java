 ...
 * @author hp
 */
@WebServlet(name = "efectuarcambiorol", urlPatterns = {"/efectuarcambiorol"})
public class efectuarcambiorol extends HttpServlet {
Connection conexion;
    @Override
    public void init ()
    {try
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
         ...
         Object menu = session.getAttribute("menu");
            out.println("<title>Servlet efectuarcambiorol</title>");            
            out.println("</head>");
            out.println("<body>");
             ...
             try
            {
             ...
             String logear2 ="UPDATE usuarios SET privilegio='"+nombre+"' where usuario='"+user+"'";
