 ...
 * @author ruth
 */
@WebServlet(urlPatterns = {"/efectuarcambiouser"})
public class efectuarcambiouser extends HttpServlet {
Connection conexion;
    @Override
    public void init ()
    {try
        ...
        try {
         ...
         Object privilegio = session.getAttribute("privilegio");
             ...
             try
            {
             ...
             String logear2 ="UPDATE usuarios SET usuario='"+usuario+"' where usuario='"+user+"'";
